            ...
            <?php else: ?>
                ...
                <?php foreach ($posts as $post): ?>
                    <div class="post_content">
                        ...
                        <div>
                            <div>
                                <p class="post_user"><?= htmlspecialchars($post['autor']) ?></p>
                        ...
                        <div class="post_actions">
                            ...
                            <form action="/post/vote" method="POST" class="vote-form">
                                ...
                                <button type="submit"
                                        class="upvote-button <?php if ($post['userHasVoted']) echo 'active'; ?>">
                ...
                <?php else: ?>
                    <?php foreach ($atividades as $atividade): ?>
                        <a href="/post/ver?id=<?= $atividade['id_alvo'] ?>">
                            <span class="font-bold"><?= htmlspecialchars($atividade['autor']) ?></span>
                            <?= htmlspecialchars($atividade['tipo_evento']) ?>
                            <span class="">"<?= htmlspecialchars(substr($atividade['titulo_alvo'], 0, 25)) ?>..."</span>
                        </a>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
